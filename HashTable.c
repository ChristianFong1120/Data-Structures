//Structure for a hash table of binary search trees, with such represented as a node
//The salts for the hash table initialization can be any value
//Here the salts are 128 bit values represented as an array of 2 64 bit values
